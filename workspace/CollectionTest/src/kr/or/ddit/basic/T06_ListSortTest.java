...
*/
	...
	public static void main(String[] args) {
		...
		Collections.sort(list, new Desc()); //new Desc() 를 외부정렬자라 부른다.
		
		System.out.println("desc정렬후 : " + list);
 ...
 */
class Desc implements Comparator<String>{ //정렬자로서의 객체로 사용할수있다. comparator를 구현했기때문에.
	/*
	  ...
	  -오른차순 정렬일 경우
	   ...
	   - 스트링 객체는 정렬을 위해서 compareTo()메서드사 구현되어 있는데 이 메서드의 반환값은 올므차순에 맞게 반환되도록 구현되어 있다.
	   	(Wrapper클래스와  Date, File 클래스에도 구현되어 있다.)
	   	
	   	@Override
	   	public int compare(string str1, String str2}{
	   	return atr1.compareTo(str)*2
	 
	 * */
	
	@Override
	public int compare(String str1, String str2) { //compare 메서드를 구현하면 외부정렬자로서 쓰일 수 있다.
