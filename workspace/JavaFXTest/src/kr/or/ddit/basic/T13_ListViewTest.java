...
/*		list.getSelectionModel().selectedItemProperty()
			...
			public void changed(
				...
				label.setTextFill(Color.web(newValue)); // 글자색변경 : reg와 같이 web에서 쓰는 색객체.
				//setfont(int) : 글자사이즈
				//settextfill(color) : 글자 색
				// list 의 lister 는 selectionModel() 속의 selectediemproperty 속에 있다.
			}
		});
*/
		
		//람다식으로  ListView에서 값이 선택되었을때 처리
		...
		list.setCellFactory( // 셀 한개한개를 만든다. cellfactory 로. 
