...
public class T02_LambdaTest {
	...
	*/
	...
	/*
	 	...
	 	2) a매개변수가 1개일 경우에는 괄호'()'를 생략할 수 있다.
	 		(단, '자료형 이름' 을 지정할 경우에는 괄호를 생략할 수 없다.
	 		
	 	3. '실행문'이 1개일 경우에은 {}를 생략할수 있다.
	 		(이 때, 문장의 끝을 나타내는 세미콜론(;)도 생략한다.
	 	예) a->system.out.println(a)
	 	
	 	4. 매개변수가 하나도 없으면 괄호'()'룰 생략할 수 없다.
	 	예) System.out.printlne("안녕")
	 	
	 	5. 반환값이 있을 경우에는 reutrn 명령을 사용한다.
	 	예) (a,b) -> {return a+b);
	 	
	 	6. 실행문dml retuen.  문만 있을 경우  return 명령과 '{}' 를 생략할 수 있다.
	 	예) (a,b) - > a+b
	 */
