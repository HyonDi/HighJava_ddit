 ...
 *
 */
public class TestSpeechToText { // ibmclou>watsons>autiotoText>대시보드 서비스에 speachtoText눌러서 apikey와 url복사해왔다.
	private static final String API_KEY = "q-7Vh4-CtXM21l8saPlMLgSuzmf849dIS87P4gj8MBw9";
	private static final String URL = "https://api.us-south.speech-to-text.watson.cloud.ibm.com/instances/38e9d4c8-47a3-4b17-a6f1-5866e4359cb6";
