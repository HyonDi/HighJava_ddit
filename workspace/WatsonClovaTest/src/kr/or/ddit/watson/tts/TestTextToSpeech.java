...
public class TestTextToSpeech {
	...
	private static final String API_KEY = "mSYQQnfEE5kZd1tWOMRgXjEFbojf9ZEeKZq3UIMO-4sO";
	private static final String URL = "https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/fd67719c-bbaf-49fd-9f8b-259a3b21c81a";
	...
	private void executeService() {
		// 여기바꿔보자
		String text = "Welcom to Java world! My name is HyeonJi. Nice to meet you. Have a nice day.";
		...
		try {
			...
			File file = new File("D:/Hyeonji2.wav"); // 학원에서 소리를 들을수없으니 파일로떨구도록했음.
