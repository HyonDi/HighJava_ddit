...
public class MemberIbatisTest {
	public static void main(String[] args) {
		...
		try {
			...
			Reader rd = Resources.getResourceAsReader("SqlMapConfig.xml"); //ibatis가 사용할 기능들이 들어있는 파일
			...
			// 형식) smc.insert("namespace값.(쿼리의)id값", 파라미터객체);
			//		반환값 : 성공하면 null이 반환된다.
			...
			mv2.setMem_id("d001");
			mv2.setMem_name("홍수환");
			mv2.setMem_tel("010-999-9999");
			mv2.setMem_addr("대전시 동구 대동");
			
			//update()메서드의 반환값은 성공한 레코드 수다.
