...
/*	
	//Service 객체 변수를 선언한다.
	private IMemberService memService; //서비스 인터페이스 호출
	...
	*//**
	...
	private void deleteMember() {
		...
		int cnt = memService.deleteMeber(memId);
	...
	*//**
	...
	private void insertMember() {
		...
		scan.nextLine(); //버퍼 비우기. 주소쓸때 공백까지 저장하기 위해
	...
	*//**
	...
	public void searchMember() {
		//검색할 회원 ID, 회원이름, 전화번호, 주소등을 입력하면 입력한 정보만 사용하여 검색하는 기능을 구현하시오.
