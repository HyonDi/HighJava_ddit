...
public class T07_ResourceBundleTest {
	public static void main(String[] args) {
		...
		System.out.println(Locale.getDefault());// 기본로케일값 출력
		
		
//		 ResourceBundle bundle = ResourceBundle.getBundle("db");//파라미터 : properties 파일명
		ResourceBundle bundle = ResourceBundle.getBundle("db",Locale.ENGLISH);//파라미터 2개
